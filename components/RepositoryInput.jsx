...
export default function RepositoryInput({ onSubmit, isLoading }) {
  ...
  </p><div className="flex justify-end"><Sparkles className="w-12 h-12 text-green-500 mr-28  " /></div>
</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {isLoading && (
            <div className="ml-3 flex items-center">
              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-primary-600 mr-2"></div>
              <span className="text-gray-600 text-sm">This may take a few minutes...</span>
            </div>
          )}
        </div> */}
        </form>
